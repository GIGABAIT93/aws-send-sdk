...
class AwsSendSdk extends Command
{

    protected $signature = 'aws:send';
    protected $description = 'AWS SDK for Pterodactyl';
    private $data = [];
    private $url = 'https://api.vertisanpro.com/update/billing';
